...
def generate_launch_description():
    moveit_cpp_yaml_file_name = (
        get_package_share_directory("suii_manipulation") + "/config/moveit_cpp.yaml"
    )
    declared_arguments = []
    ...
    robot_description_content = Command(
        [
            ...
            " ",
            PathJoinSubstitution([FindPackageShare("suii_manipulation"), "urdf", "suii_description.urdf.xacro"]),
            " ",
            "robot_ip:=",
            robot_ip,
            " ",
    ...
    robot_description_semantic_content = Command(
        [
            ...
            PathJoinSubstitution(
                [FindPackageShare("suii_manipulation"), "srdf", moveit_config_file]
            ),
            " ",
            "name:=",
    ...
    kinematics_yaml = load_yaml("suii_manipulation", "config/kinematics.yaml")
    ...
    ompl_planning_yaml = load_yaml("suii_manipulation", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    controllers_yaml = load_yaml("suii_manipulation", "config/controllers.yaml")
    moveit_controllers = {
